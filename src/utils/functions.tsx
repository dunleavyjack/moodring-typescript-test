...
export const spotifyGetRequest = async (url: any, token: any) => {
    setAuthHeader(token);
...
export const getSongAnalysis = async (id: any, token?: any) => {
...
export const getRecentlyPlayedTracks = async (token: any) => {
...
export const getSongAnalysisArray = async (arr: any) => {
    // Create Array of only song IDs
    const ids = arr.map((song: any) => song.track.id);
...
export const formatStr = (str: any) => {
...
export const fixCapitalization = (str: any) => {
